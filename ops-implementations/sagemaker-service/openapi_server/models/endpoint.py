...
class Endpoint(Model):
    ...
    def __init__(self, name=None, status=None, links=None, metadata=None, id=None, deployed_at=None):  # noqa: E501
        ...
        :param metadata: The metadata of this Endpoint.  # noqa: E501
